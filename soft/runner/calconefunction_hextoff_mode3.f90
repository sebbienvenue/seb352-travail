...
!!              write(*,*) pairs_xyz(jcount,1,:), 'atom 1', pairs_xyz(jcount,2,:), 'atom 2'
              if((pairs_xyz(jcount,1,1).le.(0.0E-10))&
                .and.(pairs_xyz(jcount,1,2).le.(0.0E-10))&
                .and.(pairs_xyz(jcount,1,3).le.(0.0E-10))&
                .and.(pairs_xyz(jcount,2,1).le.(0.0E-10))&
                .and.(pairs_xyz(jcount,2,2).le.(0.0E-10))) then
...
!!                write(*,*) pair_lstc(1:3)
!!                write(*,*) tripletmode12
                 if((pairs_charge(1,jcount).eq.tripletmode12(1))&
                   .and.(pairs_charge(2,jcount).eq.tripletmode12(2)).and.&
                   (pair_lste(i3).eq.tripletmode12(3))) then
...
!!
                  call hextoffsymfunction1(i1,i2,jcount,num_atoms,listdim,iindex,&
                    ...
                    dsfuncdxyz_hextoff,symfunction_hextoff,ldoforces_local,ldostress)
!!
