...
!! - readinput.f90
!!
      subroutine readsymfunctionglobalpair(keyword,&
...
!! type 1
        if(function_type_temp.eq.1)then
          backspace(nnunit)
          read(nnunit,*,ERR=99)dummy,function_type_temp,funccutoff_temp
          icount=0
          do i1=1,nelem
            do i2=i1,nelem
...
!! type 3 
         elseif(function_type_temp.eq.3)then
           backspace(nnunit)
           read(nnunit,*,ERR=99)dummy,function_type_temp,eta_temp,rshift_temp,funccutoff_temp
           icount=0
           do i1=1,nelem
             do i2=i1,nelem
               icount=icount+1 ! icount is the element pair number
