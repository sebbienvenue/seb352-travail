...
!!
      real*8 corrmatrixp_list(maxcorrdim,npairs)   ! in
...
!                  write(kalunit,*)corrmatrixp_list(i1,i4)
                  write(kalunit,'(e20.12)')corrmatrixp_list(i1,i4)
                enddo
              endif ! mpirank.eq.0
              write(kalunit,*)iseed
              write(kalunit,*)kseed
...
!! collect the corrmatrix fragments of all processes
              call mpi_gatherv(corrmatrixp_list(1,i4),&
