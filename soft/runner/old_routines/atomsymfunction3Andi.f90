...
!!
      subroutine atomsymfunction3Andi(i1,i2,iindex,natoms,natomsdim,nelem,&
...
!! END CHANGE
                              ...
                              symfunction(i2,i1) = symfunction(i2,i1) + fg*plambda_local*pfc
                              ...
                              if(ldoforces) then
                                  ...
                                  dsfuncdxyz(i2,i1,invneighboridx(i1,jcount),1) &
                                    = dsfuncdxyz(i2,i1,invneighboridx(i1,jcount),1) + dxij + dxik
                                  dsfuncdxyz(i2,i1,invneighboridx(i1,jcount),2) &
                                    = dsfuncdxyz(i2,i1,invneighboridx(i1,jcount),2) + dyij + dyik
                                  dsfuncdxyz(i2,i1,invneighboridx(i1,jcount),3) &
                                    = dsfuncdxyz(i2,i1,invneighboridx(i1,jcount),3) + dzij + dzik

                                  n=lstc(i3)
                                  dsfuncdxyz(i2,i1,invneighboridx(i1,n),1) &
                                    = dsfuncdxyz(i2,i1,invneighboridx(i1,n),1) - dxij - dxjk 
                                  dsfuncdxyz(i2,i1,invneighboridx(i1,n),2) &
                                    = dsfuncdxyz(i2,i1,invneighboridx(i1,n),2) - dyij - dyjk
                                  dsfuncdxyz(i2,i1,invneighboridx(i1,n),3) &
                                    = dsfuncdxyz(i2,i1,invneighboridx(i1,n),3) - dzij - dzjk

                                  m=lstc(i4)
                                  dsfuncdxyz(i2,i1,invneighboridx(i1,m),1) &
                                    = dsfuncdxyz(i2,i1,invneighboridx(i1,m),1) - dxik + dxjk
                                  dsfuncdxyz(i2,i1,invneighboridx(i1,m),2) &
                                    = dsfuncdxyz(i2,i1,invneighboridx(i1,m),2) - dyik + dyjk
                                  dsfuncdxyz(i2,i1,invneighboridx(i1,m),3) &
                                    = dsfuncdxyz(i2,i1,invneighboridx(i1,m),3) - dzik + dzjk
                              end if ! ldoforces
      ...
      symfunction(i2,i1) = symfunction(i2,i1) * pnorm
!!
      return
      end
