...
!! derived from getshortforces

!! called by: 
!! - getsensitivity.f90
!!
      subroutine getdchargedsfunc(num_atoms,&
...
!!
      real*8 dchargedsfunc(max_num_atoms,maxnum_funcvalues_elec)            ! out  
...
!!
        dchargedsfunc(i1,:)=tempderivative(num_layers_elec(ielem),1,:)
!!
 98     continue
      enddo ! i1 ! num_atoms
!!
