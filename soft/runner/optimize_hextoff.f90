...
!!
      subroutine optimize_hextoff(npoints,point,idx,&
...
!!
      ...
      integer totnum_weights_hextoff                   ! internal
      integer matrixsize
...
!!
      ...
      real*8 nnhextoff_list(nblock)                                     ! internal
...
!!======================================================
      totnum_weights_hextoff = 0
!!      totnum_weights_hextoff = num_weights_hextoff
!!
!!======================================================
