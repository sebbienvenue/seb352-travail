####potentials  #A faire dans un terminal general
#wget http://www.materialscloud.ch/sssp/pseudos/SSSP_eff_PBESOL.tar.gz
#tar -zxvf SSSP_eff_PBESOL.tar.gz
#verdi data upf uploadfamily SSSP_eff_PBESOL'SSSP' 'SSSP pseudopotential library'
...
'ELECTRONS': {'conv_thr': 1.e-14,'electron_maxstep': 3,},
}
